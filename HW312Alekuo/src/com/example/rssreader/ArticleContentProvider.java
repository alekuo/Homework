...
/**
 * This class implements the content provider which interacts with the database 
 * @author Alena
 *
 */
public class ArticleContentProvider extends ContentProvider {

	public static final String AUTHORITY = "com.example.rssreader";
	...
	private UriMatcher hw312URIMatcher = new UriMatcher(UriMatcher.NO_MATCH);	
	...
	public ArticleContentProvider() {
		 hw312URIMatcher = new UriMatcher(UriMatcher.NO_MATCH);
		 hw312URIMatcher.addURI(AUTHORITY, BASE_PATH, ArticlesTable);
		 hw312URIMatcher.addURI(AUTHORITY, BASE_PATH + "/#", Article_ID);
	 }
	...
	public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		switch (hw312URIMatcher.match(uri)) {
			case ArticlesTable:
				break;
			case Article_ID:
